...
<head>
    ...
    <title>@yield('title', 'Sysadmin') · PaseLista</title>
    ...
    <style>
        ...
        | selectores genéricos de Tabler ni de otros layouts de PaseLista.
        */
...
>
    ...
    @include('sysadmin.partials.ai-sidebar-items')
