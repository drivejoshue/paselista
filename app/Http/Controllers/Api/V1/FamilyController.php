...
use App\Services\Attendance\FamilyAttendanceCalendarService;

class FamilyController extends Controller
{   
        public function __construct(
        private readonly FamilyAttendanceCalendarService $attendanceCalendar
    ) {
    }
...
public function guardianCredential(Request $request): JsonResponse
{
    ...
    public function students(Request $request): JsonResponse
    {
      ...
      public function attendance(
        ...
        $this->authorizeStudentForGuardian(
            guardian: $guardian,
            studentId: $student,
            requiresAttendancePermission: true
        );
        ...
        $result = $this->attendanceCalendar
            ->build(
                schoolId: (int) $guardian->school_id,
                studentId: $student,
                requestedMonth: $data['month'] ?? null
            );
