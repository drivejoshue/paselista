...
use App\Http\Requests\Sysadmin\StoreSchoolOnboardingRequest;
...
use App\Services\Sysadmin\SchoolOnboardingService;
...
class SchoolController extends Controller
{
    ...
    public function create(): View
    {
        ...
        $defaults = [
            ...
            'cycle_starts_on' => sprintf(
                '%d-08-01',
                $cycleStartYear
            ),

            'cycle_ends_on' => sprintf(
                '%d-07-31',
                $cycleStartYear + 1
            ),
        ];
    ...
    public function store(
        StoreSchoolOnboardingRequest $request,
    ): RedirectResponse {
        try {
            $school = $this
                ->onboardingService
            ...
            return back()
                ...
                ->with(
                    'error',
                    'No se pudo completar el alta de la escuela: '
        ...
        return redirect()
            ...
            ->with(
                'status',
                'Escuela preparada correctamente: identidad, '
                .'licencia, ciclo, estructura, usuarios y apps.'
            );
    }
