...
class SystemUserController extends Controller
{
    ...
    private function actor(Request $request): User
    {
        ...
        if (
            ...
            || ! $actor->canManageSchool()
        ) {
            abort(
                403,
                'La gestión de usuarios está reservada para la administración escolar.'
            );
        }
    ...
    private function manageableRoles(User $actor): array
    {
        return match ($actor->role) {
            ...
            /*
             * El administrador escolar administra perfiles operativos,
             * pero no puede crear, suspender ni modificar otro
    ...
    private function sendCredentials(
        ...
        try {
            ...
            Log::warning('No se pudieron enviar credenciales de PaseLista.', [
                'user_id' => $user->id,
