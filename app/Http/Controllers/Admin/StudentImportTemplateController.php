...
class StudentImportTemplateController extends Controller
{
    public function __invoke(Request $request): BinaryFileResponse
    {
        ...
        $fileName = 'PaseLista_Plantilla_Alumnos_'
            .now()->format('Ymd_His')
            .'.xlsx';
        ...
        return response()
            ->download(
                $filePath,
                'PaseLista_Plantilla_Importacion_Alumnos.xlsx',
                [
                    'Content-Type' =>
    ...
    private function buildInstructionsSheet(
        ...
        $sheet->setCellValue(
            'A1',
            'PaseLista · Plantilla de importación de alumnos'
        );
        ...
        $instructions = [
            ...
            [
                ...
                'Plantel, nivel y grupo deben coincidir con los registrados en PaseLista.',
                'Sí',
                'Campus Centro',
