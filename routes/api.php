...
use App\Http\Controllers\Api\V1\StaffLiveController;
...
Route::prefix('access')
    ...
    ->group(function (): void {
        ...
        /*
         * Resumen operativo del día para
         * prefectura, kiosco y personal autorizado.
         *
         * GET /api/v1/access/live/today
         */
        Route::get(
            '/live/today',
            [StaffLiveController::class, 'today']
        )->name('live.today');
