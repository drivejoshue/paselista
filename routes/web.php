...
require __DIR__.'/ai-admin.php';
require __DIR__.'/school-permissions.php';
    require __DIR__.'/sysadmin.php';
    require __DIR__.'/sysadmin-ai.php';
